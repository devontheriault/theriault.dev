...
(function () {
  ...
  var myGlobe = Globe({ animateIn: false })
    ...
    .pointLabel(function (d) {
      ...
      return (
        '<div style="font-size:0.8rem;background:#1c2230;padding:4px 8px;border-radius:6px;border:1px solid #30363d">' +
        "<strong>" +
        label +
        "</strong><br>" +
  ...
  if (typeof topojson !== "undefined") {
    fetch("https://unpkg.com/world-atlas@2.0.2/countries-110m.json")
      ...
      .catch(function (e) {
        console.warn("[globe] country outlines failed:", e);
      });
  }
  ...
  function updateGlobe(data) {
    ...
    var maxCount = cities.reduce(function (m, c) {
    ...
    return fetch("/me")
      ...
      .then(function (me) {
        if (me && me.lat && me.lng) {
          ...
          // pointOfView resets OrbitControls — re-enable rotation
          myGlobe.controls().autoRotate = true;
          myGlobe.controls().autoRotateSpeed = 0.06;
        }
      })
